...
in linkFarm "image-deps" {
  ...
  "windows10/software.reg" = writeText "software.reg" (lib.readFile ../../profiles/windows10/software.reg);
  "windows10/system.reg" = writeText "system.reg" (lib.readFile ../../profiles/windows10/system.reg);
  "windows10/refreshenv.ps1" = writeText "refreshenv.ps1" (lib.readFile ../../profiles/windows10/refreshenv.ps1);
}
